                    ...
                    <div class="col-11">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <a
                                    ><b
                                        >FitViz: A Personal Informatics Tool for
                                        Self-management of Rheumatoid
                                        Arthritis</b
                                    ></a
                                >
                                <div class="mt-2 mb-2">
                                    <a class="btn alert-dark d-inline-block">
                                        Conference Paper</a
                                    >
                                </div>
                                <p>
                ...
                >
                    <div class="card-header">
                        <div class="d-block pb-4">
                            ...
                            <div class="btn-edit float-end" @click="reset()">
                                <i class="fa-solid fa-ellipsis"></i>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        class="mb-5"
                    >
                        <div class="card-body" v-if="authUser.id != user.id">
