            ...
            <div class="card mb-2">
                ...
                <div class="card-body">
                    <div class="mb-2">
                        ...
                        />
                        <span class="text-danger" v-if="errors.project_name">{{
                    ...
                    <div class="mb-2">
                        ...
                        />
                        <span class="text-danger" v-if="errors.project_type">{{
                    ...
                    <div class="mb-2">
                        ...
                        <Input
                            type="url"
                            v-model="data.project_url"
                            placeholder="Project URL"
                        />
                        <span class="text-danger" v-if="errors.project_url">{{
                    ...
                    <div class="mb-2">
                        ...
                        <span
                            ...
                            >{{ errors.project_description[0] }}</span
                        >
                    </div>
                </div>
